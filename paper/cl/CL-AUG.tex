...
We thank the ABVD and Lexibank maintainers for open data access, and the Glottolog team for the open reference phylogeny. This work uses only freely available data and open-source software.
\end{acknowledgments}
